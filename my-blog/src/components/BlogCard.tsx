...
<div className='flex flex-col items-center mt-4'>
  ...
  <Link 
  href={`/posts/${post.id}`}
  className={`w-full px-6 text-white text-center bg-blue-600 rounded hover:bg-blue-500 ${isDarkBackground ? 'bg-black hover:bg-red-500': 'bg-black hover:bg-red-500' }`}>
  Read More
